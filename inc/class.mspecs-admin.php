...
class Mspecs_Admin {
    ...
    public static function enqueue_scripts($hook){
        if(
            ...
            wp_enqueue_script('mspecs-admin-js', plugins_url('resources/mspecs-admin.js', MSPECS_PLUGIN_FILE), array('jquery'), filemtime(MSPECS_PLUGIN_DIR . 'resources/mspecs-admin.js'));
